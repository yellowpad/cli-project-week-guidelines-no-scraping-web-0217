...
return final_article
    while final_article["response"]["currentPage"]
        ...
        puts "Thank you for your patience. Here are all of the articles I found on the Guardian:"
          final_hash.each do |array|
            array.each do |key, value|
              if key["results"]["sectionName"] == answer
                puts key["results"]["webTitle"]
                puts key["results"]["webUrl"]
              end
            end
          end
...
class Fetcher
  ...
  attr_reader :url, :article_data, :answer

  def initialize(url, answer)
    @url = url
    @answer = answer
  ...
  def make_articles
    ...
    # def final_results(articles)
    #   puts "Thank you for your patience. Here are all of the articles I found on the Guardian:"
    #     articles.all.each do |finalresult|
    #       puts finalresult.article_name
    #       puts finalresult.article_url
    #     end
